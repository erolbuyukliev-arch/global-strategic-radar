...
# Information activity is deliberately NOT presented as military risk.
article_count = len(articles)
information_score = min(100, 25 + article_count * 3)

# Demo/placeholder strategic indicators remain clearly labelled.
...
st.caption("GLOBAL STRATEGIC RADAR v0.2 • Live information layer • Strategic scores remain demo data until validated against primary sources.")
